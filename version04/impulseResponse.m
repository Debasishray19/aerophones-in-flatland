...
%% The impulseResponse will return an impulse exciation
%% Given Inputs:
% sample_rate : audio sampling rate
% lcf         : low cut-off frequency
% hcf         : high cut-off frequency

function excitationX = impulseResponse(sample_rate, maxExcitation, lcf, hcf)
    ...
    % [Note]: We can design a high pass filter using low pass filter using 
    % spectral inversion. 
